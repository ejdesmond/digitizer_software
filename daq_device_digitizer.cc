...
int daq_device_digitizer::parseAdcConfigFile( string adcconfigfilename)
{
 ...
 // open configuration file
  ...
  cout << __LINE__ << " TOTAL Xmit groups found = " << nxmitgroups << endl;
...
void daq_device_digitizer::identify(std::ostream& os) const
{
  ...
  os  << "daq_device_digitizer Device  Event Type: " << m_eventType << " partition Jseb2 " << _partreadoutJseb2Name.c_str();
